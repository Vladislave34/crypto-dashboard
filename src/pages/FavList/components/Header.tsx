        ...
        <header className="w-full bg-[#1E293B] text-white rounded-t-xl px-8 py-4 flex justify-between items-center">
            ...
            <nav>
                <ul className="flex space-x-8 text-lg font-medium">
                    <li className="hover:text-gray-300 cursor-pointer transition-colors" onClick={()=>navigate("/Home")}>Home</li>
                    <li className="hover:text-gray-300 cursor-pointer transition-colors" onClick={()=>navigate("/Favorite")}>Favorites</li>
