...
const Diagrams : FC<Coin> = ({coin}) => {
    const [days, setDays] = useState(30)
    const {data, isLoading} = postApi.useFetchСoinByIdQuery({days : days, coin : coin});
    ...
    return (
        <div className='w-[50%]  rounded-xl border-2 border-gray-400 p-5 ' >
        {isLoading || !coin ? (
            ...
            <div className='rounded-xl border-2 border-gray-400 p-3 '>
                ...
                {chartData &&
                    <div className="flex flex-row justify-start gap-16 text-gray-500 text-lg mt-4 w-full p-3 overflow-x-auto" >
